...
// node_modules/@firebase/firestore/dist/esm5/prebuilt-e065c69d-7a321be7.js
/**
 * @license
 ...
 */
var _ = /* @__PURE__ */ __name(function(t2, e, n2, r2, i, o) {
...
function N2(t2) {
  ...
  if (E2.logLevel <= LogLevel.DEBUG) {
    var i = n2.map(S2);
    E2.debug.apply(E2, __spreadArray(["Firestore (8.3.0): " + t2], i));
  }
}
__name(N2, "N");
function A2(t2) {
  ...
  if (E2.logLevel <= LogLevel.ERROR) {
    var i = n2.map(S2);
    E2.error.apply(E2, __spreadArray(["Firestore (8.3.0): " + t2], i));
  }
}
__name(A2, "A");
function D2(t2) {
  ...
  if (E2.logLevel <= LogLevel.WARN) {
    var i = n2.map(S2);
    E2.warn.apply(E2, __spreadArray(["Firestore (8.3.0): " + t2], i));
  }
}
__name(D2, "D");
function S2(t2) {
...
function x2(t2) {
  ...
  var e = "FIRESTORE (8.3.0) INTERNAL ASSERTION FAILED: " + t2;
 ...
 * limitations under the License.
 */
var z2 = /* @__PURE__ */ __name(function(t2, e) {
...
__name(kt, "kt");
var Ot = /* @__PURE__ */ __name(function(t2, e) {
...
var Lt = /* @__PURE__ */ __name(function(t2, e, n2, r2, i, o, u) {
...
var Xt = /* @__PURE__ */ __name(function(t2, e) {
...
__name(Wt, "Wt");
var Zt = /* @__PURE__ */ __name(function(t2, e) {
 ...
 * limitations under the License.
 */
var ee = /* @__PURE__ */ __name(function(t2, e, n2, r2, i, o, u, s) {
 ...
 * limitations under the License.
 */
var Ie = /* @__PURE__ */ __name(function() {
  this.qt = void 0;
}, "Ie");
function Ee(t2, e, n2) {
 ...
 * limitations under the License.
 */
var Ce = /* @__PURE__ */ __name(function(t2, e) {
...
function qe(t2, e, n2) {
  return t2 instanceof Be ? function(t3, e2, n3) {
    var r2 = t3.value, i = He(t3.fieldTransforms, e2, n3.transformResults);
    return r2 = Xe(t3.fieldTransforms, r2, i), new Pt(t3.key, n3.version, r2, {
      hasCommittedMutations: true
    });
  }(t2, e, n2) : t2 instanceof Qe ? function(t3, e2, n3) {
    if (!Ue(t3.jt, e2))
      return new Ct(t3.key, n3.version);
    var r2 = Ye(t3, e2, He(t3.fieldTransforms, e2, n3.transformResults));
...
var Nn = /* @__PURE__ */ __name(function(t2, e, n2, r2) {
  this.Ke = t2, this.removedTargetIds = e, this.key = n2, this.We = r2;
}, "Nn");
var An = /* @__PURE__ */ __name(function(t2, e) {
  this.targetId = t2, this.je = e;
}, "An");
var Dn = /* @__PURE__ */ __name(function(t2, e, n2, r2) {
...
var Cn = /* @__PURE__ */ __name(function(t2, e) {
  this.t = t2, this.Bt = e;
}, "Cn");
function Ln(t2, e) {
 ...
 * limitations under the License.
 */
var fr = /* @__PURE__ */ __name(function() {
  var t2 = this;
  ...
  return t2.delete = function(t3) {
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(c) {
        switch (c.label) {
          case 0:
            i = e === "readonly", o = 0, u = /* @__PURE__ */ __name(function() {
              var e2, u2, a2, c2, h2;
...
var Lr = /* @__PURE__ */ __name(function(t2, e) {
  this.path = t2, this.readTime = e;
}, "Lr");
var Rr = /* @__PURE__ */ __name(function(t2, e) {
  this.path = t2, this.version = e;
}, "Rr");
var Ur = /* @__PURE__ */ __name(function(t2, e, n2, r2, i, o) {
...
var Mr = /* @__PURE__ */ __name(function(t2) {
  this.byteSize = t2;
}, "Mr");
Mr.store = "remoteDocumentGlobal", Mr.key = "remoteDocumentGlobalKey";
var qr = /* @__PURE__ */ __name(function(t2, e, n2, r2, i, o, u) {
...
var Fr = /* @__PURE__ */ __name(function(t2, e, n2) {
...
var jr = /* @__PURE__ */ __name(function(t2, e, n2, r2) {
...
var Br = /* @__PURE__ */ __name(function(t2, e, n2) {
  this.bundleId = t2, this.createTime = e, this.version = n2;
}, "Br");
Br.store = "bundles", Br.keyPath = "bundleId";
var Qr = /* @__PURE__ */ __name(function(t2, e, n2) {
  this.name = t2, this.readTime = e, this.bundledQuery = n2;
}, "Qr");
Qr.store = "namedQueries", Qr.keyPath = "name";
var Yr = __spreadArray(__spreadArray([], __spreadArray(__spreadArray([], __spreadArray(__spreadArray([], __spreadArray(__spreadArray([], [Pr.store, Vr.store, Cr.store, Ur.store, qr.store, Or.store, jr.store, Fr.store]), [Gr.store])), [Mr.store])), [zr.store])), [Br.store, Qr.store]);
var Hr = function(t2) {
  function e(e2, n2) {
    var r2 = this;
...
var Zr = /* @__PURE__ */ __name(function(t2) {
  this.Fs = t2;
}, "Zr");
function Jr(t2, e) {
  if (e.document)
...
var Gi = function() {
  ...
  return t2.prototype.Jn = function(t3, e, n2, r2) {
    ...
    var n2 = e.store(zr.store), r2 = new li(), i = /* @__PURE__ */ __name(function(t4) {
      if (r2.add(t4)) {
...
__name(Xi, "Xi");
var Wi = /* @__PURE__ */ __name(function(t2, e) {
...
var jo = function(t2) {
  ...
  return __extends(e, t2), e.prototype.Su = function(t3, e2, n2, r2) {
    ...
    }), I4 = /* @__PURE__ */ __name(function(t4, e3, n3) {
  ...
  return t2.prototype.pu = function(t3, e, n2, r2) {
    ...
    if (t3["X-Goog-Api-Client"] = "gl-js/ fire/8.3.0", t3["Content-Type"] = "text/plain", e)
      for (var n2 in e.g)
      ...
      var e2 = function(t4, e3) {
        return t4 && t4.length > 0 ? (k2(e3 !== void 0), t4.map(function(t5) {
          return function(t6, e4) {
            ...
            return n3.isEqual(X2.min()) && (n3 = Mn(e4)), new Le(n3, t6.transformResults || []);
          }(t5, e3);
        })) : [];
...
var Zo = /* @__PURE__ */ __name(function(t2, e, n2, r2, i) {
  var o = this;
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(i) {
      switch (i.label) {
        ...
        case 1:
          return i.sent(), t2.Oh.set("Offline"), n2 || (n2 = /* @__PURE__ */ __name(function() {
            return io(t2.bh);
          }, "n")), t2._s.po(function() {
...
__name(Iu, "Iu");
var Eu = /* @__PURE__ */ __name(function() {
  this.Kh = void 0, this.listeners = [];
}, "Eu");
var Tu = /* @__PURE__ */ __name(function() {
 ...
 * limitations under the License.
 */
var Lu = /* @__PURE__ */ __name(function(t2) {
  this.key = t2;
}, "Lu");
var Ru = /* @__PURE__ */ __name(function(t2) {
  this.key = t2;
}, "Ru");
var Uu = function() {
  function t2(t3, e) {
...
var Mu = /* @__PURE__ */ __name(function(t2, e, n2) {
  this.query = t2, this.targetId = e, this.view = n2;
}, "Mu");
var qu = /* @__PURE__ */ __name(function(t2) {
...
var Is = function() {
  ...
  return t2.prototype.initialize = function(t3, e) {
    ...
    return e = this.bh, n2 = this.Sh, r2 = t3._s, i = /* @__PURE__ */ __name(function(t4) {
      return Yu(u._a, t4, 0);
    }, "i"), o = Mo.Kn() ? new Mo() : new Uo(), new Zo(e, n2, r2, i, o);
...
var Ds = /* @__PURE__ */ __name(function(t2) {
  this._methodName = t2;
}, "Ds");
var Ss = /* @__PURE__ */ __name(function(t2) {
  this.d_ = t2;
}, "Ss");
/**
 * @license
...
function Gs(t2, e) {
  ...
  if (t2 instanceof Ss && (t2 = t2.d_), xs("collection", "path", e), t2 instanceof qs)
    return Vs(n2 = Z2.ot.apply(Z2, __spreadArray([e], r2))), new zs(t2, null, n2);
  ...
  return Vs(n2 = Z2.ot.apply(Z2, __spreadArray([t2.path], r2)).child(Z2.ot(e))), new zs(t2.firestore, null, n2);
}
__name(Gs, "Gs");
function Bs(t2, e) {
  for (var n2, r2 = [], i = 2; i < arguments.length; i++)
  ...
  if (t2 instanceof Ss && (t2 = t2.d_), arguments.length === 1 && (e = V2.u()), xs("doc", "path", e), t2 instanceof qs)
    return Ps(n2 = Z2.ot.apply(Z2, __spreadArray([e], r2))), new Fs(t2, null, new tt(n2));
  if (!(t2 instanceof Fs || t2 instanceof zs))
    throw new q2(M2.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
  return Ps(n2 = t2.D_.child(Z2.ot.apply(Z2, __spreadArray([e], r2)))), new Fs(t2.firestore, t2 instanceof zs ? t2.v_ : null, new tt(n2));
}
__name(Bs, "Bs");
function Qs(t2, e) {
...
function ma2(t2, e, n2) {
  ...
  try {
    return new (As.bind.apply(As, __spreadArray([void 0], e.split("."))))().f_;
  } catch (r2) {
...
__name(Ha2, "Ha");
var Ka2 = /* @__PURE__ */ __name(function() {
}, "Ka");
function Xa2(t2) {
...
var Sc2 = function(t2) {
  ...
  return __extends(e, t2), e.prototype.get = function(t3) {
    ...
    for (var r2, i = [], o = 3; o < arguments.length; o++)
      i[o - 3] = arguments[o];
    var u = jc2(t3);
    return arguments.length === 2 ? this.d_.update(u, e2) : (r2 = this.d_).update.apply(r2, __spreadArray([u, e2, n2], i)), this;
...
var Oc2 = function(t2) {
  ...
  return __extends(e, t2), e.pd = function(t3, n2, r2) {
    ...
    try {
      return arguments.length === 1 ? dc2(this.d_, t3) : dc2.apply(void 0, __spreadArray([this.d_, t3, e2], n2));
    } catch (t4) {
    ...
    return new e(this.firestore, t3 ? this.d_.withConverter(kc2.gd(this.firestore, t3)) : this.d_.withConverter(null));
  }, e;
}(Ss);
...
var zc2 = function(t2) {
  function e() {
    for (var e2 = [], n2 = 0; n2 < arguments.length; n2++)
      e2[n2] = arguments[n2];
    return t2.call(this, new (As.bind.apply(As, __spreadArray([void 0], e2)))()) || this;
  }
  __name(e, "e");
...
function L3(e) {
  ...
  }), e.registerVersion("@firebase/firestore", "2.2.0");
}
__name(L3, "L");
